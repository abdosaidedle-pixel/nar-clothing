...
const bannerSlides = [
  { src: imgBFFBlack,    label: "Born From Fire",    sub: "Black — Drop 001" },
  { src: imgBFFOffWhite, label: "Born From Fire",    sub: "Off White — Drop 001" },
  { src: imgBFFBurgundy, label: "Born From Fire",    sub: "Burgundy — Drop 001" },
  { src: imgBTBLBlack,   label: "Born To Be Loud",   sub: "Black — Drop 001" },
  { src: imgBTBLWhite,   label: "Born To Be Loud",   sub: "White — Drop 001" },
  { src: imgBlackout,    label: "Blackout Collection", sub: "Black — Drop 001" },
];

// Countdown target: 1 week (7 days) from page load
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <motion.span
        ...
        data-testid={`countdown-drop1-${label.toLowerCase()}`}
      >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* All images stacked — fade via opacity */}
...
export default function Drop1Section() {
  ...
  return (
    <section id="drop-001" className="relative py-24 md:py-36 overflow-hidden bg-black border-t border-border/20">
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground text-sm md:text-base tracking-wide leading-relaxed max-w-md">
                ...
                Born From Fire, Built For The Streets.<br />
            ...
            >
              <button
                ...
                data-testid="button-notify-drop1"
              >
